...
// import { LandingLanguageSelector } from "@/components/LandingLanguageSelector"; //commented language selector
...
export function Navbar() {
  ...
  return (
    <>
      <nav className={`sticky top-0 w-full z-50 transition-all duration-300 ${isScrolled ? "bg-transparent backdrop-blur-lg" : "bg-transparent"}`}>
