...
const deepFeatures = [
    {
        ...
        description: "Deploy AI agents that sound genuinely human. Our advanced speech synthesis and recognition engines capture emotional nuance, natural pauses, and subtle regional accents across more than 30 languages.",
        bullets: ["Emotional tone matching", "30+ global languages supported", "Ultra-low latency transcription"],
        icon: MicVocal,
